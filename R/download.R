...
#' combinations of crops, variables, SSP scenarios, or water management levels.
#' Useful for comparative studies or bulk data acquisition.
#'
...
#'   "WHEA" (wheat).
#' @param ssps Character vector - SSP scenarios to download. Default is "SSP370".
#'   For historical periods, use "HIST".
...
#'   time_period, climate_model, download_dir, overwrite, verbose.
#'
...
#'
#' @details
#' Creates all combinations of the specified variables, crops, ssps, and water
#' management levels using \code{expand.grid()}, then downloads each combination
#' sequentially. Progress is reported for each download.
#'
