...
- Package vignettes:
  - Advanced Usage: `vignette("advanced-usage", package = "gaezv5")`
  - Data Dictionary: `vignette("data-dictionary", package = "gaezv5")`

## Citation

When using GAEZ v5 data, please cite:

> FAO and IIASA. 2023. Global Agro-Ecological Zones v5 (GAEZ v5).
