...
### Preview Data Without Downloading (NEW in v0.2.0)

Explore data interactively before committing to downloads:

```{r}
# Interactive leaflet map preview (no download needed!)
preview_gaez_map(
...
# Custom region preview
preview_gaez_map(
  variable = "RES05-YX",
  crop = "rice",
  bbox = c(68, 6, 97, 36),  # India region (xmin, ymin, xmax, ymax)
  time_period = "FP4160"
)

# Benefits:
# - 100-300x faster than downloading full datasets
# - ~100 KB preview vs ~800 MB full dataset
# - Perfect for teaching, validation, and quick exploration
...
### Country-Level Batch Operations
...
### Validate Climate/SSP Combinations
